import '/alert_notif/pass_error/pass_error_widget.dart';
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        'To Access debug features we have to make sure you\'re someone we know, please input the key we have provided to the select individuals we\'ve assigned this software to.',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (FFAppState().passkey == '4koLang\'To') {
                                    setState(() {
