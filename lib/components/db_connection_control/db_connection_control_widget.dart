...
class DbConnectionControlWidget extends StatefulWidget {
  ...
  State<DbConnectionControlWidget> createState() =>
      _DbConnectionControlWidgetState();
}
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              24.0, 4.0, 0.0, 0.0),
                          child: Text(
                            'Set below are your connection details',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: FlutterFlowTheme.of(context)
                            ...
                            children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              // Just add the variable options here . - EJ
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child:
                                      // Note to Adrian: Write a condition that would hide the other rows containing connection status, since it is directly connected to the connection logic. - EJ
                                      //
                                      Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Column(
